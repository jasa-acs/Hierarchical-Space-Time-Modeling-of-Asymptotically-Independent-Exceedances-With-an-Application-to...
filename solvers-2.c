...
void  ellipse_ellipse_overlap_wrap(double *res,double *PHI_1, double *A1, double *B1, 
                                double *H1, double *K1, double *PHI_2, 
                                double *A2, double *B2, double *H2, double *K2)
      ...
      
{
	...
	*res = ellipse_ellipse_overlap_gsl(*PHI_1, *A1, *B1, 
                 *H1, *K1, *PHI_2, *A2, *B2,  *H2,  *K2, x, y, &nroots,
                 &rtnCode, choice);
